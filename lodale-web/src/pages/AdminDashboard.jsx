              ...
              if (Array.isArray(list)) {
                list.forEach((lp) => {
                  ...
                  if (rawS === "active_vacant" || rawS === "approved" || rawS === "live" || rawS === "active" || lp.status === "Live") {
                    ...
                    sLabel = "Rejected";
                  } else if (rawS === "info_requested" || rawS === "needs_proof") {
                    sLabel = "Info Requested";
                  }
                  ...
                  if (!map.has(key)) {
                    map.set(key, {
                      ...
                      rent: lp.price || lp.rent || formatCurrency(lp.rent_amount || lp.rent || 2500000, "/yr"),
                      ...
                      docName: lp.docName || lp.ownership_doc || 'Legal_Document.pdf',
                      docDataUrl: lp.docDataUrl || lp.ownership_doc_url,
                      deedVerified: true
                    });
                  } else {
          ...
          if (Array.isArray(localProps)) {
            const updated = localProps.map((p) => {
              if (p.id === listingId || p.title === propertyTitle || (p.name && p.name === propertyTitle)) {
                return { ...p, status: "active_vacant", rawStatus: "active_vacant", isPending: false };
              }
              return p;
            });
