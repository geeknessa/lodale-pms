            ...
            <div className="reliability-scroll-content">
              {scoreDetails.paymentHistory ? (
                <>
                  ...
                  {scoreDetails.reviews && scoreDetails.reviews.length > 0 && (
                    <div className="reliability-card-section">
                      <div className="reliability-card-section-title">
                ...
                <div className="reliability-empty-state flex flex-col items-center justify-center p-8 text-center text-ink-500">
                  <Star className="h-10 w-10 text-ink-300 mb-3" />
                  <h4 className="font-bold text-ink-900 text-sm mb-1">No Rating History Yet</h4>
                  <p className="text-xs max-w-[250px]">
                    This tenant hasn't received any verified landlord ratings or performance evaluations yet.
                  </p>
                </div>
              )}
            </div>
